		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi, {{$name}}</h3>
						<p class="lead">Thank you for choosing <a href="{{config('app.url')}}">{{config('app.name')}}</a> . We are delighted to have you as one of our highly esteemed customer! </p>
										...
										<tr>
											<td>				
												...
												<p class="">
													...
													<a href="mailto:contact@anexon.org" class="soc-btn gp">Google+</a></p>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p>Phone: <strong><a href="tel:+2348055815035">0805 581 5035</a></strong><br/>
                Email: <strong><a href="mailto:contact@anexon.org">contact@anexon.org</a></strong></p>
