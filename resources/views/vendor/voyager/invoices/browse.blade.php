...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                 <a href="{{route('invoice.index')}}" class="btn btn-primary btn-sm">View Invoices</a>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="invoice_type" required>
                                        ...
                                        <option type="text" value="Deposite Invoice" class="form-control">Deposite Invoice</option>
                                        <option type="text" value="Paid and Not Yet Supplied Invoice" class="form-control">Paid and Not Yet Supplied Invoice</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Deposite Amount</label>
                                            <input type="number" class="form-control" placeholder="Deposite Amount" name="deposite_amount">
                                        </div>
                                ...
                                <button class="add_form_field btn btn-danger">Add New Field &nbsp; 
                                  <span style="font-size:16px; font-weight:bold;">+ </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control" placeholder="Serial No" name="serial_no[]" required>
                                        </div>
