...
@section('head')
    ...
    <meta name="description" content=" Weekend sales is our big sales of the week. Anexon Global Ventures is an excellent E-commerce platform that makes buying and selling easy. We give you a safe, comfortable, secure and excellent shopping experience. We deal on products like Phones and Tablets, Men's fashion, Women's fashion, Electronics, Health and Beauty, Computing, Grocery, Sporting Goods, Home and Kitchen. Feel free shopping with us.">
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="form-group">
                <label for="filterSortBy"><ul>By Price</ul></label><br>
                <a class="btn btn-default btn-primary" href="{{ route('shop.index', ['category' => request()->category, 'subCategory' => request()->subCategory, 'sort' => 'low_high']) }}">Low to High</a><br><br>
