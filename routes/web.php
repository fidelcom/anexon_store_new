...
Route::post('/contact-us/Anexon Global Ventures', 'ContactController@store')->name('contact.store');

Route::group(['prefix' => 'admin'], function () {
    Voyager::routes();

    //route for generating invoice
    Route::get('/all-invoices', 'AdminController@index')->name('invoice.index');
    ...
    Route::get('/edit-invoice/{invoice_id}', 'AdminController@edit')->name('invoice.edit');
    Route::post('/invoice-update/{invoice_id}', 'AdminController@update')->name('invoice.update');


	//route for generating quotation
    Route::get('/all-quotation', 'QuotationController@index')->name('quotation.index');
    Route::post('/quotation-store', 'QuotationController@store')->name('quotation.store');
    Route::get('/quotation/{quotation_id}', 'QuotationController@show')->name('quotation.show');
    Route::get('/edit-quotation/{quotation_id}', 'QuotationController@edit')->name('quotation.edit');
    Route::post('/quotation-update/{quotation_id}', 'QuotationController@update')->name('quotation.update');
});
