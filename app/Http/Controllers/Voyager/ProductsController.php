...
class ProductsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $sellerForProduct = $product->sellers()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCategories', 'categoriesForProduct', 'allSubCategories', 'subCategoriesForProduct', 'allSellers', 'sellerForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        SellerProduct::where('product_id', $id)->delete();
    ...
    protected function updateProductCategories(Request $request, $id)
        {
            ...
            //this one is for seller and product
            if ($request->seller) 
            {       
