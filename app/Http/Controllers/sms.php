...
//if (isset($_POST['button'])) {
    ...
    $sendername = substr('Anexon', 0, 11);
    $recipients = '7035369612';
    $message = 'Dear Fidelis, '.$paymentDetails['data']['metadata']['name'].' ordered for an item on Testech. his number is '.$paymentDetails['data']['metadata']['phone'].' login @ '.config('app.url');
    $flash = 0;
